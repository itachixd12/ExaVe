...
tabla += "<tr>" +
    ...
    `<td class='border px-2 py-1'>${
        pedido.estado === 'pendiente'
            ? `<button class='bg-red-600 text-white px-2 py-1 rounded eliminar-pedido-btn' data-id='${pedido.id}'>Eliminar</button>`
            : ''
    }</td>` +
    "</tr>";
        });
